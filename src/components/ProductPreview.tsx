// Decorative product preview — a CSS mock of a verified athlete profile + AI,
// so visitors see what LEAF looks like without a screenshot.
export function ProductPreview() {
  return (
    <div className="relative mx-auto max-w-3xl">
      <div className="pointer-events-none absolute -inset-x-10 -top-10 bottom-0 glow-accent opacity-60" />
